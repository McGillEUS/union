 /* -------------------------------------------------------------- 
  ...
  jQuery(document).ready(function(){
        ...
        var laread_media_manager;


        // when click on the upload button
        jQuery('.laread_media_uploader_button').live('click' , function(e){
              ...
              // open the frame
              if(laread_media_manager){

                  laread_media_manager.open();
                  return ;
              }


              // create the media frame
              laread_media_manager = wp.media.frames.laread_media_manager = wp.media({
              ...
              laread_media_manager.on('select', function(){
              
                      var selection = laread_media_manager.state().get('selection');
