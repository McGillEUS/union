...
if(!class_exists('DSF_POST_META'))
{
	class DSF_POST_META {
		 ...
		 * Constructor
		 */
		function __construct($prefix = 'laread' , $fields , $scripts = '' , $styles = '' , $nonce) {
		...
		public function print_fe_scripts()
		{
				...
				wp_register_script('laread_theme_media_gallery' , get_template_directory_uri() . '/core/post-meta/post-meta-script.js' , 'jquery');
				wp_enqueue_script('laread_theme_media_gallery');
		}
		               ...
		               case 'select' :
		                ...
		                case 'media_gallery' :
	                		 ...
	                		 $out = '<div class="drop_meta_item gallery">
	                            ...
	                            <input type="button" name="uploader" class="laread_media_uploader_button button button-primary" value="'.__('Add Images' , 'laread').'">
	                            <div class="meta_description"><p>'.$field['desc'].'</p></div>
	                            </div><!-- end inner -->
	                            </div><!-- end single meta -->';
 ...
 */
$meta_styles = array(
	'blogget-meta-css' =>  get_template_directory_uri() . '/core/post-meta/post-meta-styles.css'
	);
 ...
 */
$post_fields = array(
                    'id' => 'laread-meta-items',
                    'title' => __('Gallery Options','laread'),
                    'page' => array('post','laread_gallery'),
                    'context' => 'normal',
                    'priority' => 'high',
                    'fields' => array(
                                        array(
                                        	'id' => 'buzz_media_gallery' ,
                                        	'desc' => __('Create gallery and upload images by clicking on upload button , For multiple images selection , hold "CTRL (windows) / Command (mac) " button on your keyboard when clicking .' , 'laread'),
                                        	'name' => __('Create Gallery' , 'laread') ,
                                        	'type' => 'media_gallery'
                                        )
