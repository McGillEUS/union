...
<div class="container">
	<div class="top-bar">
		...
		<?php endif ?>
		<?php if ($post_format == 'image' or ( empty($post_format.$custom_format) and has_post_thumbnail() )): ?>
			<div class="post-item-banner">
				<?php the_post_thumbnail(array( 780, 449));  ?>
			</div>
		<?php endif ?>
		...
		<?php if ($post_format=='gallery' and has_post_thumbnail() ): ?>
			<div class="post-item-banner">
				<?php the_post_thumbnail(array( 780, 449));  ?>
			</div>
		<?php endif ?>
		...
		<div class="col-md-12 no-margin-top">
			...
			<div class="post-item post-item-detail">
				<div class="post-item-paragraph">
					...
					<h1><a href="#" class="quick-read" data-postid="<?php the_ID(); ?>"><i class="fa fa-eye"></i></a><?php the_title(); ?></h1>
					<?php if (has_excerpt()): ?>
